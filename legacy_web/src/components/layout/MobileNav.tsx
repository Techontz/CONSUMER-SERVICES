              ...
              return (
                ...
                >
                  <div className="flex items-stretch">
                    <Link
                      ...
                      className={cn(
                        ...
                        active ? "text-gold-400" : "text-ivory-100",
                      )}
                    >
                      {item.label}
                    </Link>
                  ...
                  {subs.length ? (
                    ...
                    >
                      <div>
                        <ul className="mb-5 border-l border-gold-500/30 pl-5">
                          {subs.map((s) => (
                            <li key={s.label}>
                              <Link
                                href={s.href}
                                ...
                                className="flex items-center gap-3.5 py-2.5 text-[0.9375rem] leading-snug text-ivory-100/75 transition-colors duration-300 hover:text-gold-400"
                              >
