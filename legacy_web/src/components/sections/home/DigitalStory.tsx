...
export function DigitalStory() {
  return (
    <Section tone="evergreen" seam="top" className="py-24 lg:pb-28 lg:pt-36">
      ...
      <RevealGroup
        as="ol"
        className="mt-16 grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-3 lg:mt-20 lg:grid-cols-5 lg:gap-x-8"
      >
        {digitalStory.flow.map((step) => (
          ...
          >
            ...
            />
            <span className="u-index block text-brass-500">{step.n}</span>
