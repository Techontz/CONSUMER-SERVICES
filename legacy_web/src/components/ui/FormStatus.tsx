  ...
  return (
    <div
      ...
      className={cn(
        "border p-10 lg:p-12",
        dark
          ? "border-gold-500/40 bg-evergreen-700"
          : "border-gold-500/50 bg-ivory-200",
      )}
    >
      <span
        aria-hidden
        className="flex size-11 items-center justify-center rounded-full border border-gold-500 text-gold-600"
      >
        &#10003;
      </span>
      ...
      {reference ? (
        ...
        >
          Reference{" "}
          <span className={dark ? "text-gold-400" : "text-gold-700"}>
            {reference}
          </span>
        </p>
      ) : null}
