        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-16">
            <Reveal className="lg:col-span-5">
              ...
              <span
                aria-hidden
                className="mt-8 block h-px w-24 bg-gold-500"
              />
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <Reveal delay={0.16} className="lg:col-span-3">
            <div className="flex h-full flex-col justify-center border border-rule bg-ivory-50 p-10 text-center">
              ...
              <span
                aria-hidden
                className="mx-auto mt-5 block h-px w-14 bg-gold-500"
              />
              <span className="u-eyebrow mt-5 justify-center text-gold-700">
                Established
              </span>
            </div>
          </Reveal>
